...
bool CIniFile::SetValueI( string const keyname, string const valuename, long const value, bool const create)
{
...
long CIniFile::GetValueI(string const keyname, string const valuename, long const defValue) const
{
	char svalue[MAX_VALUEDATA];
