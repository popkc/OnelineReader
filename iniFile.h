...
#define MAX_VALUENAME  32
#define MAX_VALUEDATA 256
...
public:
  ...
  long    GetValueI(string const keyname, string const valuename, long const defValue = 0) const;
  ...
  bool SetValueI( string const keyname, string const valuename, long const value, bool const create = true);
